...
setup(
    ...
    project_urls={
        'Bug Reports': 'https://github.com/codabl/celo-etl/issues',
        'Source': 'https://github.com/codabl/celo-etl',
    },
)
